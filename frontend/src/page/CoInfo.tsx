...
function CoInfo() {
    ...
    return (
        ...
        <Box sx = {{backgroundColor:'White', minHeight: '100vh'}}>
            ...
            <Box sx={{paddingLeft: '4vw', paddingRight: '5vw' }}>
                <Box sx={name}>
                    <BusinessIcon sx={{fontSize: 60,paddingTop:1}}/>{/*企業アイコンでもあり。サイズは不安*/}
                    <Typography variant="h3" gutterBottom>
                    企業名
                    </Typography>
                    <Typography variant="h6" gutterBottom sx={{paddingTop:3.5, paddingLeft:4}}>
                    業種
                    </Typography>
                </Box>
                ...
                <Box sx={{display: 'flex', margin: 3}}>
                    <Box>
                    <Box sx={{ flex: 1, marginLeft: 3, marginRight: 4 }}>
                    ...
                    <TabContext value={value}>
                        ...
                        <TabPanel value="1">
                            ...
                            <Box>
                                <Typography variant="h6">Black Rate</Typography>
                            </Box>

                            <Box sx={{ position: 'relative', display: 'flex', justifyContent: 'center',alignItems: 'center', marginTop:3}}>
                    ...
                    <List
                        ...
                        subheader={
                            <ListSubheader component="div" sx={{backgroundColor:'#ebf0fa', color:'#0a1228'}}>企業情報</ListSubheader>
                        }
                    >
